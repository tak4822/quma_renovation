...
<div class="about-page pages-container">
  ...
  <section class="vision">
    ...
    <div class="contents regular-container">
      ...
      <div class="text wow fadeInUp">
        ...
        <p>「自分と暮らす」</p>
        <p>あなたの暮らしにずっと寄り添い合えるパートナーを目指しています。</p>
      </div>
    </div>
  </section>
  ...
  <section class="strength">
    ...
    @endslot
    @slot('text')
    <p>お金の話から、街探し・物件探し、リノベーションの設計・プランニング、施工まで、ずっと同じ担当者があなたのリノベーションを責任を持ってサポートいたします。</p>
    <p>リノベーションが終わった後も、アフターフォローはもちろんのこと、暮らしを楽しんで頂けているか、些細なことでも教えていただけるような関係を目指しています。</p>
    @endslot
    ...
    @slot('text')
    <p>
      弊社では、自社での設計士とは別に独立された設計士さんの方々とパートナーとして協力しております。設計士さんはそれぞれ得意分野があり、個性も様々です。案件担当者がお客様と打ち合わせをする中で、お客様のご要望を叶えられるよう設計士さんをアサインさせていただきます。
    </p>
    <p>たくさんの設計士さんと繋がりを持っているので、型にはまることない空間設計をご提供します。</p>
    @endslot
